...
SRC = src/minishell.c src/parsing/parsing_controll.c src/parsing/spliter.c src/parsing/heredoc_controll.c src/parsing/spliter_handlers.c src/parsing/not_complete_line_checker.c src/parsing_tools/parsing_tools.c 
