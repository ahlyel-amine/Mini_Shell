...
# endif
# ifndef ERR_AND
#  define ERR_AND				"minishell: syntax error near \
unexpected token `&&'"
# endif
# ifndef ERR_1AND
#  define ERR_1AND				"minishell: syntax error near \
unexpected token `&'\n"
# endif
# ifndef ERR_OR
#  define ERR_OR					"minishell: syntax error near \
unexpected token `||'"
# endif
# ifndef ERR_PIPE
#  define ERR_PIPE				"minishell: syntax error near \
unexpected token `|'"
# endif
# ifndef ERR_UNCLSDP
#  define ERR_UNCLSDP			"minishell: syntax error near \
unexpected token `('\n"
# endif
# ifndef ERR_CLSD_PARNETHISE
#  define ERR_CLSD_PARNETHISE	"minishell: syntax error near \
unexpected token `)'\n"
# endif
